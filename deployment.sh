sudo aws s3api create-bucket --bucket labcollectorsourcebucket121 --region ap-southeast-1 --create-bucket-configuration LocationConstraint=ap-southeast-1
cp lambda_function/* venv/lib/python3.6/dist-packages
rm package.yaml
sam package --template-file template.yaml --s3-bucket labcollectorsourcebucket121 --output-template-file package.yaml
